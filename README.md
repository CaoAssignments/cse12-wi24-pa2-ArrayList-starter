...
<tr>
   ...
   <td>
      ...
      <ul>
         <li>
            Rotate left an element at index in the range [0, size - 1]
         </li>
      </ul>
   </td>
   <td>
...
* `Object[] data`: 
    ...
    * Invalid elements within the `data` array (from index `size` to `data.length`) should always be set to null.
...
list.size() -> 6
list.rotate(1)
list.data -> [<b>1</b>, <b>null</b>, <b>null</b>, <b>2</b>, <b>3</b>, <b>null</b>, null, null]
list.rotate(2)
